...
protected:
  ...
  // Every scrap of state lives in the implementation object, which is reference
  // counted and outlives this facade: the event queue, LwIP's callback argument and
